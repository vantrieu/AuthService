    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var duplicatePhoneNumber = await _userManager.Users.AnyAsync(x => x.PhoneNumber == user.PhoneNumber);

                if (duplicatePhoneNumber)
                {
                    ModelState.AddModelError(string.Empty, $"PhoneNumber '{user.PhoneNumber}' is already taken");
                }
                else
                {
